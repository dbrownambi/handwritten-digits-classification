...
# Fitting the SGDClassifier to the Training set
from sklearn.linear_model import SGDClassifier
sgd_clf = SGDClassifier(max_iter=10, verbose=1, learning_rate='constant', 
                        eta0=0.0001, random_state=42)
...
crs_vld=cross_val_score(sgd_clf, X_train, y_train, cv=3, scoring="accuracy")
