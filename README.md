# MNIST
[Compared and analyzed](EE258_Project_F17.pdf) the performance of the the following **7** different machine learning algorithms for classifying the MNIST dataset based on their validation accuracy
